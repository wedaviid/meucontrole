...
export function Sidebar({ pagina, onChangePagina, aberto = false, onFechar }: SidebarProps) {
  ...
  const conteudo = (
    <>
      <div className="p-5 border-b border-slate-800 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400">Finanças da família</p>
          </div>
        </div>
        {onFechar && (
      ...
      <div className="p-4 border-t border-slate-800">
        <div className="flex items-center gap-3">
          <div className="w-8 h-8 rounded-full bg-indigo-600 flex items-center justify-center text-xs font-semibold">RD</div>
          <div className="text-sm">
            <p className="font-medium text-white">Renner David</p>
